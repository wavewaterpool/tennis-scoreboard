...
class TennisMatch:
    ...
    def point_won_by(self, player_index):
        ...
        game_winner = self.current_game.point_won_by(player_index)
    ...
    def get_score_display(self):
        ...
        s = f"Sets: {self.sets_won[0]} - {self.sets_won[1]}<br>"
        s += f"Games: {self.current_set.games[0]} - {self.current_set.games[1]}<br>"
    ...
    def from_dict(cls, data):
        """For deserialization.
        """
        match = cls(data["players"][0], data["players"][1])
